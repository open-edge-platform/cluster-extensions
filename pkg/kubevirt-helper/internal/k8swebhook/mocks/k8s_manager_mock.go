...
func (_m *MockManager) AddMetricsExtraHandler(path string, handler http.Handler) error {
...
func (_m *MockManager) GetControllerOptions() v1alpha1.ControllerConfigurationSpec {
	ret := _m.Called()
...
func (_m *MockManager) SetFields(_a0 interface{}) error {
	ret := _m.Called(_a0)
